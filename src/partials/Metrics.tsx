  ...
  return (
    <section id="metrics" className="mx-auto px-4 py-10 leading-loose">
      <h2 className="text-4xl md:text-5xl font-normal text-center max-w-5xl mx-auto mb-24">
        A next-gen POS that is <span className="bg-[#E5CBF9] rounded">fast</span>,
        <div className="mt-4 md:mt-6">
          <span className="bg-[#F5D6BA] rounded">intuitive</span> and <span className="bg-[#CBE6FA] rounded">boosts sales</span>
        </div>
      </h2>
