...
export const Intro = () => {
  return (
    <main className="mx-auto mt-4 md:mt-8 p-6 md:p-12 flex flex-col md:flex-row items-center justify-between">
      <div className="md:w-2/3 space-y-6 lg:pr-12">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal leading-tight">
          <span className="bg-[#F5D6BA] px-1 rounded-lg inline-block transform transition hover:scale-105">
            Get More,
          </span>{" "}
          <span className="bg-[#E5CBF9] px-1 rounded-lg inline-block transform transition hover:scale-105">
            Pay Less,
          </span>{" "}
          <span className="mt-2 md:mt-4 bg-[#CBE6FA] px-1 rounded-lg inline-block transform transition hover:scale-105">
            Sell Smarter
          </span>
        </h1>
      ...
      <div className="md:w-1/3 mt-12 md:mt-0 relative">
        <Image
          src="/payment-terminal.svg"
          alt="Rooter Payment Terminal"
          width={500}
          height={500}
          className="rounded-2xl shadow-2xl transform transition hover:scale-105 duration-500"
        />
